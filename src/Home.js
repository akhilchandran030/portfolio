...
const Home = () => {
    ...
    const resume = "https://drive.google.com/file/d/14-HYgU2YD4luHresIQIdPwTqGjK9lsKV/view?usp=sharing";
    return (
        <>
            <div className="maindiv" id='home'>
                ...
                <div className='maindiv_home'>
                    ...
                    <div className='cv_button'>
                        <button className='download_cv'><a href={resume} download="My_Resume.pdf" target='_blank'>Resume</a></button>
                    </div>
                </div >
            </div>
        </>
